...
''' Aqui vamos fazer uma série temporal com a produção de produtos energéticos e não energéticos derivados do petróleo para os anos de 2019 e 2020.'''
...
#Plotando o gráfico da produção total de produtos energéticos e não energéticos do petróleo durante os anos de 2009 a 2018
plt.figure(figsize = (10, 5))
plt.title('Produção total de todos os produtos energéticos e não energéticos')
plt.xlabel('Anos')
...
modelo = ARIMA(total, order = [0, 0, 1])
...
#Plota o gráfico da previsão de 2009 a 2020
eixo = total.plot()
