...
'''Aqui vamos usar um método de classificação usando a Floresta Randômica,
para saber como o computador irá dizer qual o tipo de derivado do petróleo cada produto pertence. '''
...
'''Obs: Como constatado, a taxa de acerto foi 100%, com 30% de dados para teste.''' 