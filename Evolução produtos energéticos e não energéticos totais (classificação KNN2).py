...
'''Agora vamos treinar o algoritmo knn, ajustando o número de vizinhos e usar a base de treinamento para treinar o modelo
   sobre o n_neighbors(número de vizinhos) o valor é ajustado de acordo com a sua vontade. Os valores padrões são 3 ou 5 '''
...
'''Obs: Como constatado, a taxa de acerto do modelo foi 22.2%, aproximadamente, com 30% de dados para teste.
   Desempenho pífio'''
