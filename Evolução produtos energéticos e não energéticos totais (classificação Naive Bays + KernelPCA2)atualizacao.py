...
#Aplicação do PCA, que tem a função de reduzir a dimensionalidade dos atributos utilizando kernels
kpca = KernelPCA(n_components = 1, kernel = 'rbf')
X_treinamento = kpca.fit_transform(X_treinamento)
X_teste = kpca.transform(X_teste)
...
'''Obs: Como constatado, a taxa de acerto do modelo foi 64.4%, aproximadamente, com 30% de dados para teste.
        Com o KernelPCA aplicado, a taxa de acerto do modelo foi 62.2%, aproximadamente, com 30% de dados para teste,
        mas o seu processamento foi mais rápido.'''