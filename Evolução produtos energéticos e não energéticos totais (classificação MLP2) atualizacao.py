...
'''Aqui vamos usar um método de classificação usando o MLP, para saber como o computador irá dizer qual o tipo energético de cada produto derivado do petróleo. '''
...
rede = MLPClassifier(hidden_layer_sizes = (100,), max_iter = 1500, tol = 0.00000001, verbose = True)
